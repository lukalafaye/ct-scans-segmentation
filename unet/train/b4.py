...
VAL_PREDICTIONS_DIR = os.path.join(DATA_FOLDER, "unet_partial_predictions_b4_randomval")
DEBUGGING_DIR = os.path.join(DATA_FOLDER, "debugging_b4_randomval")
...
def main():
    ...
    trainer = pl.Trainer(
        ...
        callbacks=[
            ...
            ModelCheckpoint(
                dirpath="models/",
                filename="b4partial-randval-unet-{epoch:02d}-{val_discrete_dice:.4f}",
